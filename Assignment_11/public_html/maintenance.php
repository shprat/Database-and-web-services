  ...
  <body style="margin: 0; background: #b86464">
    ...
    <div class="container-center-horizontal">
      <div class="maintenance-page screen">
        ...
        <div class="entities roboto-normal-black-29px">press hyperlink to Logout</div>
        <div class="frame-3"><div class="place roboto-normal-black-29px"><a href = "logout.php">Logout</a></div></div>
